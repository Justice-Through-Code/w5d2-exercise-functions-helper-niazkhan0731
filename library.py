...
'''
1. The data in books_with_details is structured as a list of dictionaries.
2. Within the list are nested dictionaries, and within dictionaries is nested the key-value pairs.
'''
...
result = search_by_author('Yuval Noah Harari')
print(result)
